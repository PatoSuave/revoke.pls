...
| `DEXTOOLS_API_KEY` | Optional | Server-only DEXTools key for Token Chair market/score enrichment. Do not use a `NEXT_PUBLIC_` key. Start at `https://developer.dextools.io/` to request access. |
