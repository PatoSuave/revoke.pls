...
| `DEXTOOLS_API_KEY` | Optional | Server-only DEXTools key for Token Chair market/score enrichment. This paid/plan-gated integration stays hidden unless configured. Do not use a `NEXT_PUBLIC_` key. |
