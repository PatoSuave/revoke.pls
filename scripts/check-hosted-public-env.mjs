...
const DENIED_PUBLIC_EXPLORER_KEYS = new Set([
  ...
  "NEXT_PUBLIC_LINEA_EXPLORER_API_KEY",
  "NEXT_PUBLIC_BLAST_EXPLORER_API_KEY",
  "NEXT_PUBLIC_BERACHAIN_EXPLORER_API_KEY",
  "NEXT_PUBLIC_CELO_EXPLORER_API_KEY",
  "NEXT_PUBLIC_GNOSIS_EXPLORER_API_KEY",
  "NEXT_PUBLIC_UNICHAIN_EXPLORER_API_KEY",
  "NEXT_PUBLIC_WORLDCHAIN_EXPLORER_API_KEY",
  "NEXT_PUBLIC_MONAD_EXPLORER_API_KEY",
  "NEXT_PUBLIC_KATANA_EXPLORER_API_KEY",
  "NEXT_PUBLIC_SEI_EXPLORER_API_KEY",
  "NEXT_PUBLIC_PLASMA_EXPLORER_API_KEY",
  "NEXT_PUBLIC_ABSTRACT_EXPLORER_API_KEY",
  "NEXT_PUBLIC_FRAXTAL_EXPLORER_API_KEY",
  "NEXT_PUBLIC_TAIKO_EXPLORER_API_KEY",
  "NEXT_PUBLIC_OPBNB_EXPLORER_API_KEY",
  "NEXT_PUBLIC_MOONBEAM_EXPLORER_API_KEY",
  "NEXT_PUBLIC_APECHAIN_EXPLORER_API_KEY",
  "NEXT_PUBLIC_XDC_EXPLORER_API_KEY",
...
const PLACEHOLDER_VALUES = new Set([
  ...
  "PASTE_YOUR_SONIC_EXPLORER_KEY_HERE",
  "PASTE_YOUR_AVALANCHE_EXPLORER_KEY_HERE",
  "PASTE_YOUR_MANTLE_EXPLORER_KEY_HERE",
  "PASTE_YOUR_LINEA_EXPLORER_KEY_HERE",
  "PASTE_YOUR_BLAST_EXPLORER_KEY_HERE",
  "PASTE_YOUR_BERACHAIN_EXPLORER_KEY_HERE",
  "PASTE_YOUR_CELO_EXPLORER_KEY_HERE",
  "PASTE_YOUR_GNOSIS_EXPLORER_KEY_HERE",
  "PASTE_YOUR_UNICHAIN_EXPLORER_KEY_HERE",
  "PASTE_YOUR_WORLDCHAIN_EXPLORER_KEY_HERE",
  "PASTE_YOUR_MONAD_EXPLORER_KEY_HERE",
  "PASTE_YOUR_KATANA_EXPLORER_KEY_HERE",
  "PASTE_YOUR_SEI_EXPLORER_KEY_HERE",
  "PASTE_YOUR_PLASMA_EXPLORER_KEY_HERE",
  "PASTE_YOUR_ABSTRACT_EXPLORER_KEY_HERE",
  "PASTE_YOUR_FRAXTAL_EXPLORER_KEY_HERE",
  "PASTE_YOUR_TAIKO_EXPLORER_KEY_HERE",
  "PASTE_YOUR_OPBNB_EXPLORER_KEY_HERE",
  "PASTE_YOUR_MOONBEAM_EXPLORER_KEY_HERE",
  "PASTE_YOUR_APECHAIN_EXPLORER_KEY_HERE",
  "PASTE_YOUR_XDC_EXPLORER_KEY_HERE",
  "PASTE_YOUR_ETHERSCAN_V2_KEY_HERE",
  "YOUR_ETHERSCAN_V2_KEY",
  "your_bscscan_key",
  "your_polygonscan_key",
  "your_sonic_explorer_key",
  "your_avalanche_explorer_key",
  "your_mantle_explorer_key",
  "your_linea_explorer_key",
  "your_blast_explorer_key",
  "your_berachain_explorer_key",
  "your_celo_explorer_key",
  "your_gnosis_explorer_key",
  "your_unichain_explorer_key",
  "your_worldchain_explorer_key",
  "your_monad_explorer_key",
  "your_katana_explorer_key",
  "your_sei_explorer_key",
  "your_plasma_explorer_key",
  "your_abstract_explorer_key",
  "your_fraxtal_explorer_key",
  "your_taiko_explorer_key",
  "your_opbnb_explorer_key",
  "your_moonbeam_explorer_key",
  "your_apechain_explorer_key",
  "your_xdc_explorer_key",
]);
