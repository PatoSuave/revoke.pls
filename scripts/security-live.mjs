...
const SECRET_PATTERNS = [
  ...
  },
  {
    ...
    pattern:
      /\b(?:PRIVATE_KEY|MNEMONIC|SEED_PHRASE|SECRET_ACCESS_KEY|AWS_SECRET|VERCEL_TOKEN|ETHERSCAN_API_KEY|POLYGONSCAN_API_KEY|BSCSCAN_API_KEY|BASESCAN_API_KEY|BSC_EXPLORER_API_KEY|BASE_EXPLORER_API_KEY|POLYGON_EXPLORER_API_KEY|SONIC_EXPLORER_API_KEY|AVALANCHE_EXPLORER_API_KEY|MANTLE_EXPLORER_API_KEY|LINEA_EXPLORER_API_KEY|BLAST_EXPLORER_API_KEY|BERACHAIN_EXPLORER_API_KEY|CELO_EXPLORER_API_KEY|GNOSIS_EXPLORER_API_KEY|UNICHAIN_EXPLORER_API_KEY|WORLDCHAIN_EXPLORER_API_KEY|MONAD_EXPLORER_API_KEY|KATANA_EXPLORER_API_KEY|SEI_EXPLORER_API_KEY|PLASMA_EXPLORER_API_KEY|ABSTRACT_EXPLORER_API_KEY|FRAXTAL_EXPLORER_API_KEY|TAIKO_EXPLORER_API_KEY|OPBNB_EXPLORER_API_KEY|MOONBEAM_EXPLORER_API_KEY|APECHAIN_EXPLORER_API_KEY|XDC_EXPLORER_API_KEY|ARBISCAN_API_KEY|OPTIMISM_EXPLORER_API_KEY|OPTIMISTIC_ETHERSCAN_API_KEY|HYPEREVM_EXPLORER_API_KEY|HYPEREVM_ETHERSCAN_API_KEY|HYPERSCAN_API_KEY)\b\s*[:=]\s*["'][^"'\r\n]{8,}["']/i,
  },
  {
