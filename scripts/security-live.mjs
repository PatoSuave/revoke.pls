...
const SECRET_PATTERNS = [
  ...
  },
  {
    ...
    pattern:
      /\b(?:PRIVATE_KEY|MNEMONIC|SEED_PHRASE|SECRET_ACCESS_KEY|AWS_SECRET|VERCEL_TOKEN|ETHERSCAN_API_KEY|POLYGONSCAN_API_KEY|BSCSCAN_API_KEY|BASESCAN_API_KEY|POLYGON_EXPLORER_API_KEY|SONIC_EXPLORER_API_KEY|AVALANCHE_EXPLORER_API_KEY|MANTLE_EXPLORER_API_KEY|LINEA_EXPLORER_API_KEY|BLAST_EXPLORER_API_KEY|BERACHAIN_EXPLORER_API_KEY|CELO_EXPLORER_API_KEY|GNOSIS_EXPLORER_API_KEY|UNICHAIN_EXPLORER_API_KEY|WORLDCHAIN_EXPLORER_API_KEY|ARBISCAN_API_KEY|OPTIMISTIC_ETHERSCAN_API_KEY|HYPERSCAN_API_KEY)\b\s*[:=]\s*["'][^"'\r\n]{8,}["']/i,
  },
  {
