...
- Source-driven Quick Sniff rows do not stay at `Not checked yet` after a completed scan; they show returned source signals, `Not flagged by source scan`, or `Unable to verify`.
