...
| `/api/discovery/approvals` | Strict per-client rate limit for shared BSC/Base/Polygon/Sonic/Avalanche/Mantle/Linea/Blast/Berachain/Celo/Gnosis/Unichain/World Chain discovery. |
