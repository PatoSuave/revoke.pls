...
describe("server approval discovery shared Etherscan key", () => {
  ...
  it.each([
    ...
    },
    {
      ...
      displayName: "Monad",
      chainid: MONAD_EXPLORER_CHAIN_ID_DEFAULT,
      keyEnvNames: ["MONAD_EXPLORER_API_KEY", "ETHERSCAN_API_KEY"],
    },
    {
      chainId: KATANA_CHAIN_ID,
      displayName: "Katana",
      chainid: KATANA_EXPLORER_CHAIN_ID_DEFAULT,
      keyEnvNames: ["KATANA_EXPLORER_API_KEY", "ETHERSCAN_API_KEY"],
    },
    {
      chainId: SEI_CHAIN_ID,
      displayName: "Sei",
      chainid: SEI_EXPLORER_CHAIN_ID_DEFAULT,
      keyEnvNames: ["SEI_EXPLORER_API_KEY", "ETHERSCAN_API_KEY"],
    },
    {
      chainId: PLASMA_CHAIN_ID,
      displayName: "Plasma",
      chainid: PLASMA_EXPLORER_CHAIN_ID_DEFAULT,
      keyEnvNames: ["PLASMA_EXPLORER_API_KEY", "ETHERSCAN_API_KEY"],
    },
    {
      chainId: ABSTRACT_CHAIN_ID,
      displayName: "Abstract",
      chainid: ABSTRACT_EXPLORER_CHAIN_ID_DEFAULT,
      keyEnvNames: ["ABSTRACT_EXPLORER_API_KEY", "ETHERSCAN_API_KEY"],
    },
    {
      chainId: FRAXTAL_CHAIN_ID,
      displayName: "Fraxtal",
      chainid: FRAXTAL_EXPLORER_CHAIN_ID_DEFAULT,
      keyEnvNames: ["FRAXTAL_EXPLORER_API_KEY", "ETHERSCAN_API_KEY"],
    },
    {
      chainId: TAIKO_CHAIN_ID,
      displayName: "Taiko Mainnet",
      chainid: TAIKO_EXPLORER_CHAIN_ID_DEFAULT,
      keyEnvNames: ["TAIKO_EXPLORER_API_KEY", "ETHERSCAN_API_KEY"],
    },
    {
      chainId: OPBNB_CHAIN_ID,
      displayName: "opBNB",
      chainid: OPBNB_EXPLORER_CHAIN_ID_DEFAULT,
      keyEnvNames: ["OPBNB_EXPLORER_API_KEY", "ETHERSCAN_API_KEY"],
    },
    {
      chainId: MOONBEAM_CHAIN_ID,
      displayName: "Moonbeam",
      chainid: MOONBEAM_EXPLORER_CHAIN_ID_DEFAULT,
      keyEnvNames: ["MOONBEAM_EXPLORER_API_KEY", "ETHERSCAN_API_KEY"],
    },
    {
      chainId: APECHAIN_CHAIN_ID,
      displayName: "ApeChain",
      chainid: APECHAIN_EXPLORER_CHAIN_ID_DEFAULT,
      keyEnvNames: ["APECHAIN_EXPLORER_API_KEY", "ETHERSCAN_API_KEY"],
    },
    {
      chainId: XDC_CHAIN_ID,
      displayName: "XDC Network",
      chainid: XDC_EXPLORER_CHAIN_ID_DEFAULT,
      keyEnvNames: ["XDC_EXPLORER_API_KEY", "ETHERSCAN_API_KEY"],
    },
  ] as const)(
