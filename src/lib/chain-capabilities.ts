...
export const CHAIN_CAPABILITIES: Record<number, ChainCapability> = {
  ...
  [KATANA_CHAIN_ID]: {
    ...
    confirmationStrategy: "rollup-safe-finalized-aware",
    notes: [
      "Katana is an Ethereum L2 with ETH gas.",
      "Katana wallet estimates may include L1 data fees beyond gas-price estimates.",
      "Final revoke state still requires receipt and live re-check.",
    ],
  },
  [SEI_CHAIN_ID]: {
  ...
  [ABSTRACT_CHAIN_ID]: {
    ...
    confirmationStrategy: "rollup-safe-finalized-aware",
    notes: [
      "Abstract uses viem's ZKsync-style chain configuration.",
      "Abstract wallet estimates may include L1 data fees beyond gas-price estimates.",
      "Final revoke state still requires receipt and live re-check.",
    ],
  },
  [FRAXTAL_CHAIN_ID]: {
    ...
    confirmationStrategy: "rollup-safe-finalized-aware",
    notes: [
      "Fraxtal wallet estimates may include L1 data fees beyond gas-price estimates.",
      "Final revoke state still requires receipt and live re-check.",
    ],
  },
  [TAIKO_CHAIN_ID]: {
    ...
    confirmationStrategy: "rollup-safe-finalized-aware",
    notes: [
      "Taiko wallet estimates may include L1 data fees beyond gas-price estimates.",
      "Final revoke state still requires receipt and live re-check.",
    ],
  },
  [OPBNB_CHAIN_ID]: {
    ...
    confirmationStrategy: "rollup-safe-finalized-aware",
    notes: [
      "opBNB wallet estimates may include L1 data fees beyond gas-price estimates.",
      "Final revoke state still requires receipt and live re-check.",
    ],
  },
  [MOONBEAM_CHAIN_ID]: {
  ...
  [APECHAIN_CHAIN_ID]: {
    ...
    confirmationStrategy: "rollup-safe-finalized-aware",
    notes: [
      "ApeChain wallet estimates may include L1 data fees beyond gas-price estimates.",
      "Final revoke state still requires receipt and live re-check.",
    ],
  },
  [XDC_CHAIN_ID]: {
