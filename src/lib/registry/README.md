...
over coverage. BSC, Base, Polygon, Sonic, Avalanche, Mantle, Linea, Blast, and
Berachain registries start empty; add labels only after explicit
...
- [ ] Address checked on PulseScan, BscScan, BaseScan, PolygonScan, SonicScan,
      SnowScan, Mantle Explorer, LineaScan, Blastscan, or Berascan
...
- Tokens with live circulating supply on PulseChain, verified BSC tokens,
  verified Base tokens, verified Polygon tokens, verified Sonic tokens,
  verified Avalanche tokens, verified Mantle tokens, verified Linea tokens,
  verified Blast tokens, or verified Berachain tokens
