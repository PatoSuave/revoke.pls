...
export const SECURITY_CHAIN_STATUS_ROWS: readonly ChainStatusRow[] = [
  ...
  },
  {
    ...
    revoke: "Yes",
    status: "Live",
    note: "Shared scanner with CeloScan discovery, live verification, and revokes through your wallet. Gas is paid in CELO.",
  },
  {
    chain: "Gnosis",
    chainId: "100",
    ...
    revoke: "Yes",
    status: "Live",
    note: "Shared scanner with Gnosisscan discovery, live verification, and revokes through your wallet. Gas is paid in XDAI.",
  },
  {
    chain: "Unichain",
    chainId: "130",
    ...
    revoke: "Yes",
    status: "Live",
    note: "Shared scanner with Uniscan discovery, live verification, and revokes through your wallet. Gas is paid in ETH.",
  },
  {
    chain: "World Chain",
    chainId: "480",
  ...
  },
  {
    ...
    revoke: "Yes",
    status: "Live",
    note: "Shared scanner with Monadscan discovery, live verification, and revokes through your wallet. Gas is paid in MON.",
  },
  {
    chain: "Katana",
    chainId: "747474",
    ...
    revoke: "Yes",
    status: "Live",
    note: "Shared scanner with Katanascan discovery, live verification, and revokes through your wallet. Gas is paid in ETH.",
  },
  {
    chain: "Sei",
    chainId: "1329",
    ...
    revoke: "Yes",
    status: "Live",
    note: "Shared scanner with Seiscan discovery, live verification, and revokes through your wallet. Gas is paid in SEI.",
  },
  {
    chain: "Plasma",
    chainId: "9745",
    ...
    revoke: "Yes",
    status: "Live",
    note: "Shared scanner with PlasmaScan discovery, live verification, and revokes through your wallet. Gas is paid in XPL.",
  },
  {
    chain: "Abstract",
    chainId: "2741",
    ...
    revoke: "Yes",
    status: "Live",
    note: "Shared scanner with Abscan discovery, live verification, and revokes through your wallet. Gas is paid in ETH.",
  },
  {
    chain: "Fraxtal",
    chainId: "252",
    ...
    revoke: "Yes",
    status: "Live",
    note: "Shared scanner with Fraxscan discovery, live verification, and revokes through your wallet. Gas is paid in FRAX.",
  },
  {
    chain: "Taiko Mainnet",
    chainId: "167000",
    ...
    revoke: "Yes",
    status: "Live",
    note: "Shared scanner with TaikoScan discovery, live verification, and revokes through your wallet. Gas is paid in ETH.",
  },
  {
    chain: "opBNB",
    chainId: "204",
    ...
    revoke: "Yes",
    status: "Live",
    note: "Shared scanner with opBNB BscScan discovery, live verification, and revokes through your wallet. Gas is paid in BNB.",
  },
  {
    chain: "Moonbeam",
    chainId: "1284",
    ...
    revoke: "Yes",
    status: "Live",
    note: "Shared scanner with Moonscan discovery, live verification, and revokes through your wallet. Gas is paid in GLMR.",
  },
  {
    chain: "ApeChain",
    chainId: "33139",
    ...
    revoke: "Yes",
    status: "Live",
    note: "Shared scanner with ApeScan discovery, live verification, and revokes through your wallet. Gas is paid in APE.",
  },
  {
    chain: "XDC Network",
    chainId: "50",
    ...
    revoke: "Yes",
    status: "Live",
    note: "Shared scanner with XDCScan discovery, live verification, and revokes through your wallet. Gas is paid in XDC.",
  },
  {
