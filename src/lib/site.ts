...
export const siteConfig = {
  ...
  description:
    "Pulse Revoke is a non-custodial tool to review and revoke token and NFT approvals on PulseChain, BSC, Base, Ethereum Mainnet, and Arbitrum One. Open source, read-only until you sign.",
