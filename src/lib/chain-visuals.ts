...
export const CHAIN_VISUALS: Record<string, ChainVisual> = {
  ...
  Monad: {
    ...
    accentBorder: "rgba(124, 58, 237, 0.34)",
    accentShadow: "0 0 20px rgba(124, 58, 237, 0.24)",
  },
  Katana: {
    accent: "#F97316",
    ...
    accentShadow: "0 0 20px rgba(249, 115, 22, 0.24)",
  },
  Sei: {
    accent: "#E11D48",
    accentReadable: "#BE123C",
    accentSoft: "rgba(225, 29, 72, 0.12)",
    accentBorder: "rgba(225, 29, 72, 0.34)",
    accentShadow: "0 0 20px rgba(225, 29, 72, 0.24)",
  },
  Plasma: {
    accent: "#22C55E",
    accentReadable: "#15803D",
    accentSoft: "rgba(34, 197, 94, 0.12)",
    accentBorder: "rgba(34, 197, 94, 0.34)",
    accentShadow: "0 0 20px rgba(34, 197, 94, 0.24)",
  },
  Abstract: {
    accent: "#F8FAFC",
    ...
    accentShadow: "0 0 20px rgba(248, 250, 252, 0.24)",
  },
  Fraxtal: {
    accent: "#00E5A8",
    accentReadable: "#047857",
    accentSoft: "rgba(0, 229, 168, 0.12)",
    accentBorder: "rgba(0, 229, 168, 0.34)",
    accentShadow: "0 0 20px rgba(0, 229, 168, 0.24)",
  },
  "Taiko Mainnet": {
    accent: "#FF5A8A",
    accentReadable: "#BE185D",
    accentSoft: "rgba(255, 90, 138, 0.12)",
    accentBorder: "rgba(255, 90, 138, 0.34)",
    accentShadow: "0 0 20px rgba(255, 90, 138, 0.24)",
  },
  opBNB: {
    accent: "#F0B90B",
    accentReadable: "#A16207",
    accentSoft: "rgba(240, 185, 11, 0.12)",
    accentBorder: "rgba(240, 185, 11, 0.34)",
    accentShadow: "0 0 20px rgba(240, 185, 11, 0.24)",
  },
  Moonbeam: {
    accent: "#53CBC8",
    accentReadable: "#0F766E",
    accentSoft: "rgba(83, 203, 200, 0.12)",
    accentBorder: "rgba(83, 203, 200, 0.34)",
    accentShadow: "0 0 20px rgba(83, 203, 200, 0.24)",
  },
  ApeChain: {
    accent: "#2D6BFF",
    accentReadable: "#1D4ED8",
    accentSoft: "rgba(45, 107, 255, 0.12)",
    accentBorder: "rgba(45, 107, 255, 0.34)",
    accentShadow: "0 0 20px rgba(45, 107, 255, 0.24)",
  },
  "XDC Network": {
    accent: "#31D6FF",
    accentReadable: "#087F9E",
